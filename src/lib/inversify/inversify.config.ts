...
import { AvatarCommand } from 'commands';
...
// Env
container.bind<string>(TYPES.Token).toConstantValue(process.env.BOT_CLIENT_TOKEN || '');
container.bind<string>(TYPES.Prefix).toConstantValue(process.env.BOT_PREFIX || '!');
